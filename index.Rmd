...
* Crear un modelo para la estimación de volúmenes (m3/ha) de trozas en plantaciones de pino radiata  

## **Objetivos específicos** 

* Identificar las variables que pueden afectar a la obtención de diferentes trozas  
* Ajustar y seleccionar una configuración óptima del modelo  
